...
|---|---|---|
| `builtin` | Repository-owned standards and intent review | Configuration is portable; local reviewer-result artifacts are structural metadata only and cannot unlock PR readiness |
